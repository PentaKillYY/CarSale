...
- (UIImageView *)creatImageView{
    ...
    UIImageView *imgView = [[UIImageView alloc] initWithFrame:CGRectMake(80, 0, width-160, height)];
...
- (void)setCurIndex:(NSInteger)curIndex{
    ...
    // 判断数据类型 根据数据类型抉择使用情况
    // 如果需要使用URL，请导入延展
    [[NSNotificationCenter defaultCenter] postNotificationName:@"ImageIndex" object:@(_curIndex)];
    if (_imgSource.count) {
