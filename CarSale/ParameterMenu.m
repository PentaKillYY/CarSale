...
@implementation ParameterMenu
+(NSString *)getTableName
{
    return @"ParameterMenuTable";
}
...
+(void)initialize
{
    ...
    [self setTableColumnName:@"PerentId" bindingPropertyName:@"parentId"];
...
@implementation NSObject(PrintParameterMenuSQL)
